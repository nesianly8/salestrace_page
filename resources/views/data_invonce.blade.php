...
@section('content')
    <section class="create-invoice py-4 d-flex justify-content-center bg-vektor">
        <div class="row mt-4">
            ...
            <div class="col-md-12">
                <h3 class="title-page-content">
                    ...
                    Jika Anda telah membeli sesuatu untuk bisnis Anda, dan Anda tidak harus melunasi segera, 
                    <br> dapat mencatatnya sebagai tagihan.
                </p>
                </h3>
            </div>
    ...
    <section class="flow-invoice mt-4 d-flex justify-content-center">
        <div class="row mt-4">
            <div class="col-md-12 d-flex justify-content-center">
                <h3 class="title-page-content">
                    Bagaimana INVOICE bekerja
                </h3>
            </div>
            <div class="col-md-12">
                <h3 class="title-page-content">
                    <p class="subtitle-page-content">
                    ini adalah siklus INVOICE Salestrace bekerja
                </p>
                </h3>
            </div>
            <div class="col-md-12 d-flex justify-content-center">
            ...
            <div class="col-md-12 d-flex justify-content-center">
                <img src="omsetku-assets/omsetku-flow-inv1.png" alt="">
            </div>
    ...
    <section class="Anda Dapat mt-4" style="padding:10px">
        ...
        <div class="d-flex justify-content-center" style="margin-right: 60px;">
