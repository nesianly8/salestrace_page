...
@section('content')
    <section class="create-REIMBURSE  py-4 d-flex justify-content-center bg-vektor">
        <div class="row mt-4">
            ...
            <div class="col-md-12">
                <h3 class="title-page-content">
                    ...
                    Pengeluaran belum didanani tenang aja, ada fitur REIMBURSE
                </p>
                </h3>
            </div>
    ...
    <section class="flow-REIMBURSE  mt-4 d-flex justify-content-center">
        <div class="row mt-4">
            <div class="col-md-12 d-flex justify-content-center">
                <h3 class="title-page-content">
                    Bagaimana REIMBURSE  bekerja
                </h3>
            </div>
            <div class="col-md-12">
                <h3 class="title-page-content">
                    <p class="subtitle-page-content">
                    ini adalah siklus REIMBURSE  Salestrace bekerja
                </p>
                </h3>
            </div>
            <div class="col-md-12 d-flex justify-content-center">
            ...
            <div class="col-md-12 d-flex justify-content-center">
                <img src="omsetku-assets/omsetku-flow-reim.png" alt="">
            </div>
            <div class="col-md-12 d-flex justify-content-center" style="margin-top:30px; padding-left: 27px;">
                <div class="warning-page-content row">
                    ...
                    <p class="warning-page-text" style="margin: 0px">
                        Dengan sistem seperti manajemen tasking memudahkan pekerjaan dalam membuat reimburse untuk
                        <br>customer
                    </p>
                </div>
            </div>
    ...
    <section class="Anda Dapat mt-4" style="padding:10px">
        <div class="d-flex justify-content-center">
            <h2 style="color: #464A53;font-size: 18px;font-weight: 500;">Dibagian REIMBURSE, Anda dapat :</h2>
        </div>
        <div class="d-flex justify-content-center" style="margin-right: 80px;">
            <ul style="list-style-type: none; padding: 0; text-align: left; display: inline-block;">
                <li style="margin-bottom: 10px; display: flex; align-items: center;">
                    ...
                    Atur status reimburse
                </li>
                <li style="margin-bottom: 10px; display: flex; align-items: center;">
                    <img src="omsetku-assets/omsetku-checklist.png" alt="" style="margin-right: 5px;">
                    Buat reimburse untuk sales
                </li>
                <li style="margin-bottom: 10px; display: flex; align-items: center;">
                    <img src="omsetku-assets/omsetku-checklist.png" alt="" style="margin-right: 5px;">
                    Pilih kebutuhan reimburse
                </li>
            </ul>
        </div>
    </section>
