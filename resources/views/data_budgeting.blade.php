...
@section('content')
    <section class="create-budgeting py-4 d-flex justify-content-center bg-vektor">
        <div class="row mt-4">
            ...
            <div class="col-md-12">
                <h3 class="title-page-content">
                    ...
                    Atur pengeluaran dan anggaran bulanan kamu dan tim <br> kamu dengan BUDGETING
                </p>
                </h3>
            </div>
    ...
    <section class="flow-invoice mt-4 d-flex justify-content-center">
        <div class="row mt-4">
            <div class="col-md-12 d-flex justify-content-center">
                <h3 class="title-page-content">
                    Bagaimana BUDGETING bekerja
                </h3>
            </div>
            <div class="col-md-12">
                <h3 class="title-page-content">
                    <p class="subtitle-page-content">
                    ini adalah siklus BUDGETING Salestrace bekerja
                </p>
                </h3>
            </div>
            <div class="col-md-12 d-flex justify-content-center">
            ...
            <div class="col-md-12 d-flex justify-content-center" style="padding-left: 60px;">
                <img src="omsetku-assets/omsetku-flow-budg.png" alt="">
            </div>
            <div class="col-md-12 d-flex justify-content-center" style="margin-top:30px; padding-left: 75px;">
                <div class="warning-page-content row">
                    ...
                    <p class="warning-page-text" style="margin: 0px">
                        Dengan sistem seperti manajemen tasking memudahkan pekerjaan dalam membuat budgeting<br>
                        dana tahunan
                    </p>
                </div>
            </div>
