...
@section('content')
    <section class="create-KOMISI  py-4 d-flex justify-content-center bg-vektor">
        <div class="row mt-4">
            ...
            <div class="col-md-12">
                <h3 class="title-page-content">
                    ...
                    Buat sales anda lebih bersemangat dengan menambahkan KOMISI untuk sales anda
                </p>
                </h3>
            </div>
    ...
    <section class="flow-KOMISI  mt-4 d-flex justify-content-center">
        <div class="row mt-4">
            <div class="col-md-12 d-flex justify-content-center">
                <h3 class="title-page-content">
            ...
            <div class="col-md-12">
                <h3 class="title-page-content">
                    <p class="subtitle-page-content">
                    ini adalah siklus KOMISI  Salestrace bekerja
                </p>
                </h3>
            </div>
            <div class="col-md-12 d-flex justify-content-center">
            ...
            <div class="col-md-12 d-flex justify-content-center">
                <img src="omsetku-assets/omsetku-flow-kom.png" alt="">
            </div>
            <div class="col-md-12 d-flex justify-content-center" style="margin-top:30px; padding-left: 27px;">
                <div class="warning-page-content row">
                    ...
                    <p class="warning-page-text" style="margin: 0px">
                        Dengan sistem seperti manajemen tasking memudahkan pekerjaan dalam membuat komisi untuk
                        <br>customer
                    </p>
                </div>
            </div>
    ...
    <section class="Anda Dapat mt-4" style="padding:10px">
        <div class="d-flex justify-content-center">
            <h2 style="color: #464A53;font-size: 18px;font-weight: 500;">Dibagian KOMISI, Anda dapat :</h2>
        </div>
