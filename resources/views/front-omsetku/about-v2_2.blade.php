...
<style>
  .hero {
    background-image: url("omsetku-asset/omsetku-bg-city.png");
  }
  ...
  .bg-gradient {
    background-image: url("omsetku-asset/omsetku-bg-life.png") !important;
  }
  ...
  /* .omsetku-bg-life{
    background-image: url("omsetku-asset/omsetku-bg-life.png");
  } */
  ...
  .bg-gradient {
    ...
    .bg-sisales {
      background-image: url("omsetku-asset/omsetku-bg-sisales.png") !important;
      width: 100%;
      min-height: 50vh;
      background-size: cover;
      background-position: center;
  ...
  .bg-res1 {
    width: 100%;
    min-height: 50vh;
    background-image: url("omsetku-asset/omsetku-bg-city.png") !important;
    background-size: cover;
    background-position: center;
    position: relative;
  ...
  <div class="container">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 order-2 order-lg-1 d-flex flex-column justify-content-center banner-text">
      ...
      <p class="content-text mb-4">
        Kepuasan pengguna adalah prioritas utama kami. Demi memberikan <br> kemudahan dan kenyamanan untuk pengguna.
      </p>
    </div>
    <div class="btn-coba-" style=" display: flex; justify-content: center; padding-top: 30px;">
      <a href="{{ url('contact') }}" target="_blank">
        
        <img class="btn-banner" src="omsetku-asset/omsetku-btn-gratis.png" alt="">
      </a>
      <a href="{{ url('login') }}" target="_blank">
        <img class="btn-banner" src="omsetku-asset/omsetku-btn-demo.png" alt="" style="margin-left: 35px;">
      </a>
    </div>
  </div>
</section>
    ...
    <div class="row gy-4 d-flex justify-content-between">
      <div class="col-12 col-sm-12 col-md-12 order-2 order-lg-1 d-flex flex-column justify-content-center banner-text">
        ...
        <p class="content-text" >
          Kepuasan pengguna adalah prioritas utama kami. Demi memberikan kemudahan dan kenyamanan untuk pengguna.
        </p>
      </div>
      <div class="col-12 col-sm-12 col-md-12 order-2 order-lg-1 banner-text">
        <div class="row">
          <div class="col-sm-6 text-center btn-atas d-flex justify-content-center">
            <a href="{{ url('contact') }}" target="_blank">
              
              <img class="btn-banner" src="omsetku-asset/omsetku-btn-gratis.png" alt="">
            </a>
            <a href="{{ url('login') }}" target="_blank">
              <img class="btn-banner" src="omsetku-asset/omsetku-btn-demo.png" alt="" style="margin-left: 5px;">
            </a>
          </div>
        </div>
      </div>
  ...
  <div class="container">
    ...
    <div class="row image-content-desktop text-center d-flex justify-content-center">
      <div class=" img-bg-col4 col-md-3 col-lg-3 col-xl-3 text-center">
        ...
        <p class="pt-2">Kami berusaha untuk membantu, <br> menghormati, dan jujur ​​dengan <br> semua rekan satu tim kami.</p>
      </div>
      <div class=" img-bg-col4 col-md-3 col-lg-3 col-xl-3 text-center">
  ...
  <div class="container">
    ...
    <div class="row pb-4">
      <div class="col-lg-6 image-section" data-aos-delay="100">
        <img src="omsetku-asset/omsetku-pengembangan.png" class="img-about" alt="" style="margin-left: 0px">
      </div>
      ...
      <div class="col-lg-6 pt-5 pt-lg-0 content" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
        ...
        <div class="row mb-4">
          ...
          <div class="col-md-11 col-lg-11">
            <h5 ><strong class="strong-blue">Kami percaya bisnis adalah platform cepat untuk melakukan perubahan.</strong></h5>
            <p class="text-about">Kami adalah mendukung dan berkomitmen untuk melakukan yang terbaik bagi semua pemangku kepentingan kami pelanggan, karyawan, mitra, komunitas dan masyarakat secara keseluruhan.
              <br><br>Dan kami memimpin dengan memberi contoh, memelopori inisiatif dalam bidang teknologi</p>
          </div><br>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="text-center" style="">
      <p>Kemudahan dan kenyamanan dalam penggunaan produk melalui layanan 
        <br> purna jual yang terbaik dan terlengkap di kelasnya.</p>
    </div>
  ...
  <div class="container">
    ...
    <div class="row image-content-desktop text-center">
      ...
      <div class="col-md-3 col-lg-3 col-xl-3 text-center">
        <img src="omsetku-asset/omsetku-icon-komisi.png" class="pb-2" alt=""><br>
        <b style="color: #02D394">KNOWLEDGE CENTER</b>
        <p class="pt-2 pb-4">Panduan produk Goodeva yang lengkap dan tersedia dalam berbagai format.</p>
      </div>
    </div>
...
<section id="about" class="about bg-gradient menu-1 desktop-show">
  <div class="container">
    <div class="row d-flex" style="flex-wrap:nowrap;">
      <div class="col-lg-5 pt-lg-0 content" style=" margin-top: 30px;">
        <div class="about-header">
      ...
      {{-- <div class="col-lg-4 image-section">
        <img src="omsetku-asset/omsetku-life-1.png" class="" alt="">
      </div>
      <div class="col-lg-4 image-section">
        <img src="omsetku-asset/omsetku-life-2.png" class="" alt="">
      </div> --}}
        <div id="carouselExample" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
              <div class="carousel-item active">
                  <img src="omsetku-asset/omsetku-life-1.png" class="" alt="Gambar 1">
              </div>
              <div class="carousel-item">
                  <img src="omsetku-asset/omsetku-life-2.png" class="" alt="Gambar 2">
              </div>
              <div class="carousel-item">
                  <img src="omsetku-asset/omsetku-life-1.png" class="" alt="Gambar 3">
              </div>
          </div>
    ...
    <div style="margin-top: -95px;">
      <a href="{{ url ('contact') }}" target="_blank">
        <img class="" src="omsetku-asset/omsetku-icon-panah-kiri.png" alt="">
      </a>
      <a href="{{ url('login') }}" target="_blank">
        <img class="" src="omsetku-asset/omsetku-icon-panah-kanan.png" alt="" style="margin-left: 10px;">
      </a>
    </div>
        ...
        {{-- <div class="about-header">
          ...
          <div class="row mb-4">
            <div class="col-md-11 col-lg-11">
              ...
              <div style="">
                <a href="{{ url ('contact') }}" target="_blank">
                  <img class="" src="omsetku-asset/omsetku-icon-wasales.png" alt="">
                </a>
                <a href="{{ url('login') }}" target="_blank">
                  <img class="" src="omsetku-asset/omsetku-icon-jadwal.png" alt="" style="">
                </a>
              </div>
            </div>
          </div>
...
<section id="about1" class="about menu-1 mobile-show" style="margin: 50px 0px 0px 0px; padding: 40px 0px 0px 0px;">
  <div class="container">
    <div class="row bg-sisales">
      <div class="col-lg-6 image-section" data-aos-delay="100">
        {{-- <img src="omsetku-asset/omsetku-mengapa2.png" class="img-about" alt="" style="margin-left: 0px"> --}}
...
@section('script-before')
    ...
    <!-- Bootstrap JS dan Popper.js (diperlukan untuk carousel) -->
...
@section('script-after')
  ...
  <!-- Add the following script to enable carousel functionality -->
  <script>
    $(document).ready(function() {
      // Activate the carousel
      $('#omsetkuSlider').carousel();
    });
  </script>
