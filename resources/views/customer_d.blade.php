                        ...
                        <div class="title-feature">
                            <h5 class="icon-text-hr d-flex align-items-center">
                                <img src="https://omsetku-dev.globaldeva.com/public/asset-home/omsetku-accordion-on-transaction.png"
                                    alt="" srcset="" class="w-icon-desk1"> Tambah Customer
                            </h5>
                            <hr class="">
                        </div>
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                ...
                                                <p class="header-text-item-kiri" >
                                                    ...
                                                    <br> 3. Nomor Telepon
                                                    <br> 4. Perusahan
                                                    <br> Lalu klik “simpan” untuk menyimpan data customer yang sudah kamu input
                                                </p>
                                            </div><br>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                ...
                                                <p class="header-text-item-kiri" >
                                                    ...
                                                    <br> 1. Data pribadi
                                                    <br> 2. Data Penjualan Produk
                                                    <br> 3. Grafik Pembelian
                                                    <br> 4. List Pembelian yang sudah dilakukan 
                                                </p>
                                            </div><br>
                                        </div>
                                    </div>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12"
                    ...
                    <div class="item-feature">
                        <div class="title-feature">
                            <h5 class="icon-text-hr d-flex align-items-center">
                                <img src="https://omsetku-dev.globaldeva.com/public/asset-home/omsetku-accordion-on-transaction.png"
                                    alt="" srcset="" class="w-icon-desk1"> Edit Customer
                            </h5>
                            <hr class="hr-item">
                        </div>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12"
                    ...
                    <div class="item-feature">
                        <div class="title-feature">
                            <h5 class="icon-text-hr d-flex align-items-center">
                                <img src="https://omsetku-dev.globaldeva.com/public/asset-home/omsetku-accordion-on-transaction.png"
                                    alt="" srcset="" class="w-icon-desk1"> Detele Customer
                            </h5>
                            <hr class="hr-item">
                        </div>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12"
                    ...
                    <div class="item-feature">
                        <div class="title-feature">
                            <h5 class="icon-text-hr d-flex align-items-center">
                                <img src="https://omsetku-dev.globaldeva.com/public/asset-home/omsetku-accordion-on-transaction.png"
                                    alt="" srcset="" class="w-icon-desk1"> Ganti Status Customer
                            </h5>
                            <hr class="hr-item">
                        </div>
                            ...
                            <div class="pad-con">
                                <div class="row pb-4 pt-4">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Membuat data customer</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Pilih  tombol "buat customer" pada dashboard <br> untuk mulai membuat customer baru untuk <br> penjualan barang mu
                                                </p>
                                            </div><br>
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Menambahkan data customer baru</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Pilih  tombol "tambah" pada dashboard untuk mulai <br> menginput data untuk customer baru
                                                </p>
                                            </div><br>
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Data Customer</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Isilah data sesuai dengan data customer yang kamu miliki:
                                                    <br> 1. Nama Customer
                                                    <br> 2. Email
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Data Customer Tersimpan</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Data customer yang kamu baru saja simpan akan muncul dalam list customer, Pilih customer baru mu untuk melihat datanya secara detail
                                                </p>
                                            </div><br>
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Customer data detail</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Setelah klik customer , maka akan muncul tampilan data customer detail mengenai :
                                                    <br> 1. Data pribadi
                                                    <br> 2. Data Penjualan Produk
                            ...
                            <div class="pad-con">
                                <div class="row pb-4 pt-4">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Edit customer</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Untuk mengedit data customer, silahkan pilih customer yang ingin kamu edit lalu , ketika muncul tampilan list seperti di samping, klik tombol edit untuk mulai mengubah data
                                                </p>
                                            </div><br>
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Mengedit data customer</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Isilah data sesuai dengan data customer yang kamu miliki:
                                                    <br> 1. Nama Customer
                                                    <br> 2. Email
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Berhasil edit customer</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Setelah kamu simpan data yang baru maka dengan otomatis data customer tersebut sudah ter-ubah di list customer
                                                </p>
                                            </div><br>
                            ...
                            <div class="pad-con">
                                <div class="row pb-4 pt-4">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Menghapus data customer</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Untuk menghapus data customer, silahkan pilih customer yang ingin kamu hapus lalu , ketika muncul tampilan list seperti di samping, klik tombol hapus untuk menghapus data customer
                                                </p>
                                            </div><br>
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Konfirmasi hapus data customer</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Ketika sudah klik tombol hapus maka akan muncul tampilan konfirmasi untuk menghapus data dari customer, klik hapus untuk menghapus dan klik batal untuk membatalkan penghapusan data customer
                                                </p>
                                            </div><br>
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Berhasil menghapus data customer</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Setelah kamu hapus data customer, Maka dengan otomatis data customer tersebut sudah ter-hapus dari di list customer
                                                </p>
                                            </div><br>
                            ...
                            <div class="pad-con">
                                <div class="row pb-4 pt-4">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Mengganti status customer</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Pilih  tombol "titik tiga" pada dashboard di customer untuk mulai mengganti status customer
                                                </p>
                                            </div><br>
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Memilih status customer</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Pilih status customer sesuai data yang ingin ditampilkan
                                                </p>
                                            </div><br>
