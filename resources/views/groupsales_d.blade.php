...
@section('content')
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade show active" id="sales">
                        ...
                        <div class="title-feature">
                            <h5 class="icon-text-hr d-flex align-items-center">
                                <img src="https://omsetku-dev.globaldeva.com/public/asset-home/omsetku-accordion-on-transaction.png"
                                    alt="" srcset="" class="w-icon-desk1"> Tambah Group Sales
                            </h5>
                            <hr class="">
                        </div>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12"
                    ...
                    <div class="item-feature">
                        <div class="title-feature">
                            <h5 class="icon-text-hr d-flex align-items-center">
                                <img src="https://omsetku-dev.globaldeva.com/public/asset-home/omsetku-accordion-on-transaction.png"
                                    alt="" srcset="" class="w-icon-desk1"> Edit Group Sales
                            </h5>
                            <hr class="hr-item">
                        </div>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12"
                    ...
                    <div class="item-feature">
                        <div class="title-feature">
                            <h5 class="icon-text-hr d-flex align-items-center">
                                <img src="https://omsetku-dev.globaldeva.com/public/asset-home/omsetku-accordion-on-transaction.png"
                                    alt="" srcset="" class="w-icon-desk1"> Hapus Group Sales
                            </h5>
                            <hr class="hr-item">
                        </div>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12"
                    ...
                    <div class="item-feature">
                        <div class="title-feature">
                            <h5 class="icon-text-hr d-flex align-items-center">
                                <img src="https://omsetku-dev.globaldeva.com/public/asset-home/omsetku-accordion-on-transaction.png"
                                    alt="" srcset="" class="w-icon-desk1"> Detail Inside Group Sales
                            </h5>
                            <hr class="hr-item">
                        </div>
                        <div class="content-feature-3 d-none h-0" style="transition: height .35s ease-in-out;">
                            {{-- DETAIL INSIDE GROUP SALES CONTENT --}}
                            <div class="pad-con">
                                <div class="row pb-4 pt-4">
                                    <div class="col-lg-6 image-section-content" data-aos-delay="100">
          ...
          {{-- Content group sales SALES Mobile Start--}}
                            ...
                            <div class="pad-con">
                                <div class="row pb-4 pt-4">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Membuat data group sales</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Pilih  tombol "buat group sales" pada dashboard <br> untuk mulai membuat group sales baru untuk <br> penjualan barang mu
                                                </p>
                                            </div><br>
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Menambahkan data group sales baru</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Pilih  tombol "tambah" pada dashboard untuk mulai <br> menginput data untuk group sales baru
                                                </p>
                                            </div><br>
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Data group sales</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Isilah data sesuai dengan data group sales yang kamu miliki:
                                                    <br> 1. Pilih sales Tulis judul
                                                    <br> 2. target penjualan, periode group 
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Data group sales Tersimpan</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Data group sales yang kamu simpan bisa terlihat di list group sales yang tersedia
                                                </p>
                                            </div><br>
                            ...
                            <div class="pad-con">
                                <div class="row pb-4 pt-4">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Edit group sales</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Untuk mengedit group sales, silahkan pilih group sales yang ingin kamu edit
                                                </p>
                                            </div><br>
                            ...
                            <div class="pad-con">
                                <div class="row pb-4 pt-4">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Menghapus data group sales</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Untuk menghapus data group sales, silahkan pilih group sales yang ingin kamu hapus
                                                </p>
                                            </div><br>
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Menghapus group sales</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Ketika muncul tampilan list seperti di samping, klik tombol titik 3 lalu pilih edit untuk mulai menghapus data
                                                </p>
                                            </div><br>
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Konfirmasi  hapus data group sales</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Ketika sudah klik tombol hapus maka akan muncul tampilan konfirmasi untuk menghapus data dari group sales, klik hapus untuk menghapus dan klik batal untuk membatalkan penghapusan data group sales
                                                </p>
                                            </div><br>
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Berhasil menghapus data group sales</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Setelah kamu hapus data group sales, Maka dengan otomatis data komisi tersebut sudah ter-hapus dari di list group sales
                                                </p>
                                            </div><br>
                            ...
                            <div class="pad-con">
                                <div class="row pb-4 pt-4">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Detail group sales</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Untuk melihat detail data group sales, silahkan pilih group sales yang ingin kamu lihat 
                                                </p>
                                            </div><br>
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Detail group sales list</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Isilah data sesuai dengan data group sales yang kamu miliki:
                                                    <br> 1. Statistik target penjualan     
                                                    <br> 2. total transaksi
                                ...
                                <div class="row pb-4 pt-4">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Detail list</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Klik masing-masing list untuk melhat data yang lebih lengkap dari setiap list 
                                                </p>
                                            </div><br>
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">List Porduk Terjual</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Berisikan data dari list produk yang sudah terjual selama periode group sales
                                                </p>
                                            </div><br>
          ...
          {{-- Content group sales SALES Mobile End--}}
        ...
        <div class="tab-pane fade" id="owner">
          ...
          {{-- Content group sales OWNER Mobile Start--}}
            <section id="content1" class="menu-1 mobile-show text-center">
              <div class="container py-4">
                {{-- ADD --}}
                <div class="col-12 col-sm-12 col-md-12 col-lg-12"
                            ...
                            <div class="pad-con">
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Edit data group sales</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Isilah data sesuai dengan data group sales yang kamu miliki:
                                                    <br> 1. Pilih sales Tulis judul
                                                    <br> 2. target penjualan periode group
          ...
          {{-- Content group sales OWNER Mobile End--}}
