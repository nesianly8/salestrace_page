...
@section('content')
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-12">
                <h3 class="title-page-content">
                    ...
                    Atur keinginan customer dari awal sampai deal dengan SALES TARGET
                </p>
                </h3>
            </div>
    ...
    <section class="flow-goupsales mt-4 d-flex justify-content-center">
        <div class="row mt-4">
            <div class="col-md-12 d-flex justify-content-center">
                <h3 class="title-page-content">
                    Bagaimana SALES TARGET bekerja
                </h3>
            </div>
            <div class="col-md-12">
                <h3 class="title-page-content">
                    <p class="subtitle-page-content">
                    ini adalah siklus SALES TARGET Salestrace bekerja
                </p>
                </h3>
            </div>
            <div class="col-md-12 d-flex justify-content-center">
            ...
            <div class="col-md-12 d-flex justify-content-center">
                <img src="omsetku-assets/omsetku-flow-tgt.png" alt="">
            </div>
            <div class="col-md-12 d-flex justify-content-center" style="margin-top:30px; padding-left: 30px;">
                <div class="warning-page-content row">
                    ...
                    <p class="warning-page-text" style="margin: 0px">
                        Dengan sistem seperti manajemen tasking memudahkan pekerjaan dalam membuat SALES TARGET untuk
                        <br> customer
                    </p>
                </div>
            </div>
    ...
    <section class="Anda Dapat mt-4" style="padding:10px">
        <div class="d-flex justify-content-center">
            <h2 style="color: #464A53;font-size: 18px;font-weight: 500;">Dibagian SALES TARGET, Anda dapat :</h2>
        </div>
        <div class="d-flex justify-content-center" style="margin-right: 72px;">
            <ul style="list-style-type: none; padding: 0; text-align: left; display: inline-block;">
                <li style="margin-bottom: 10px; display: flex; align-items: center;">
                    ...
                    Set target sales bulanan
                </li>
                <li style="margin-bottom: 10px; display: flex; align-items: center;">
                    <img src="omsetku-assets/omsetku-checklist.png" alt="" style="margin-right: 5px;">
                    Grafik ketercapaian yang transparan
                </li>
                <li style="margin-bottom: 10px; display: flex; align-items: center;">
                    <img src="omsetku-assets/omsetku-checklist.png" alt="" style="margin-right: 5px;">
