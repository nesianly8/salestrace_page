...
@section('content')
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade show active" id="sales">
                            ...
                            <div class="pad-con">
                                <div class="row pb-4 pt-4">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Membuat sales order</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Pilih  tombol "buat sales order" pada dashboard untuk mulai membuat sales order untuk penjualan barang mu
                                                </p>
                                            </div><br>
                                        </div>
                                    </div>
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Membuat sales order baru</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Klik tombol tambah untuk membuat data sales order baru
                                                </p>
                                            </div><br>
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Data sales order</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Lengkapi data penjualan barang mu sesuai dengan data yang ada 
                                                    <br> 1. Pilih customer yang melakukan transaksi
                                                    <br> 2. Tanggal Pembelian
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Tampilan sales order</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Setelah sales order dibuat maka akan muncul tampilan data sales order mu, pastikan data yang disajikan sudah benar sesuai yang kamu inginkan
                                                </p>
                                            </div><br>
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Data sales order tersimpan</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Data sales order yang kamu buat akan tampil dalam data list sales order setelah kamu simpan
                                                </p>
                                            </div><br>
                                        </div>
                                    </div>
                            ...
                            <div class="pad-con">
                                <div class="row pb-4 pt-4">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Edit sales order</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Untuk mengedit sales order, silahkan pilih sales order yang ingin kamu edit lalu , ketika muncul jendela sales order seperti di samping, klik tombol edit untuk mulai mengubah data
                                                </p>
                                            </div><br>
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Mengedit data sales order</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Mulai edit sales order mu dengan mengubah isi data yang sesuai dengan keinginan mu, 
                                                    <br> 1. Customer yang melakukan penjualan
                                                    <br> 2. Tanggal pembelian
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Berhasil edit sales order</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Setelah kamu simpan data yang baru maka dengan otomatis data sales order tersebut sudah ter-ubah di list sales order
                                                </p>
                                            </div><br>
                            ...
                            <div class="pad-con">
                                <div class="row pb-4 pt-4">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Menghapus sales order</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Untuk menghapus sales order, silahkan pilih sales order yang ingin kamu hapus lalu , ketika muncul  tampilan sales order seperti di samping, klik tombol hapus untuk mulai menghapus data
                                                </p>
                                            </div><br>
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Konfirmasi hapus sales order</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Ketika sudah klik tombol hapus maka akan muncul tampilan konfirmasi untuk menghapus data dari sales order, klik hapus untuk menghapus dan klik batal untuk membatalkan penghapusan data sales order
                                                </p>
                                            </div><br>
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Berhasil menghapus data sales order</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Setelah kamu hapus data sales order, Maka dengan otomatis data sales order tersebut sudah ter-hapus dari di list sales order
                                                </p>
                                            </div><br>
                            ...
                            <div class="pad-con">
                                <div class="row pb-4 pt-4">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Menduplikasi data sales order</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Untuk menduplikasi data sales order, silahkan pilih sales order yang ingin kamu duplikasi lalu , ketika muncul jendela sales order seperti di samping, klik tombol “duplicate” untuk mulai menduplikasi data sales order
                                                </p>
                                            </div><br>
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Konfirmasi data sales order</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Ketika sudah klik tombol simpan maka akan muncul tampilan konfirmasi untuk menduplikasi data dari sales order, 
                                                    klik selesai untuk menyelesaikan duplikasi dari data sales order mu 
                                                </p>
                                ...
                                <div class="row pb-4 pt-2">
                                    ...
                                    <div class="col-lg-6 pt-4 pl-0 pt-lg-0" data-aos-delay="100" style="display: flex; flex-direction: column; justify-content: center;">
                                        <div class="row mb-4">
                                            <div class="col-md-11 col-lg-11">
                                                <h5 class="h5-m"><strong class="header-content-item d-flex">Berhasil menduplikasi data sales order</strong></h5>
                                                <p class="header-text-item-kiri" >
                                                    Setelah kamu hapus data sales order, Maka dengan otomatis data sales order tersebut sudah ter-hapus dari di list sales order
                                                </p>
                                            </div><br>
          ...
          {{-- Content sales order SALES Mobile End--}}
        ...
        <div class="tab-pane fade" id="owner">
          ...
          {{-- Contentsales order OWNER Mobile Start--}}
            <section id="content1" class="menu-1 mobile-show text-center">
              <div class="container py-4">
                {{-- ADD --}}
                <div class="col-12 col-sm-12 col-md-12 col-lg-12"
          ...
          {{-- Content sales order OWNER Mobile End--}} 
